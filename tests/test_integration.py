        ...
        params=[
            {
                ...
                'name': 'baz',
                'label': 'Baz',
                'options': [{'label': 'Chose Me', 'name': 'chose_me'}, {'label': 'Or Me', 'name': 'or_me'}],
            }
        ]
    )
    ...
    def test_export_rule_data(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                {"name": "ten", "label": "Diez", "field_type": "numeric", "options": []},
                {'name': 'true_bool', 'label': 'True Bool', 'field_type': 'boolean', 'options': []},
            ],
        )
